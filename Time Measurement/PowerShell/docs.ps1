...
function help() {
	Write-Host(clean($helpText))
}
function version() {
	Write-Host(clean($versionText))
}

$helpText=@'

	 使い方:
	  measure-ps [options] [command] [arg1] [arg2]…
	  measure-ps -multiple [options] "[command1]" "[command2]"…
